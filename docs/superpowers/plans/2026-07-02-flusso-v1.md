...
Run: `swift build && .build/debug/Flusso --selftest-audio` from Terminal (grant microphone to the terminal app when prompted), speak during the 2 seconds.
...
swift build && .build/debug/Flusso --selftest-asr fixtures/it.wav
